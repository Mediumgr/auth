...
- В ходе разработки необходимо обработать все необходимые на ваш взгляд кейсы, вроде обработку ошибок, вывод нотисов и т.д.
- Игнорируйте тот факт что это маленькое приложении, отнеситесь к нему серьезно снизив зацепленность модулей и сделав упор на лучшие практики.
